...
public class CasiaEsCreateTest extends TestCase {
    CasiaEsCreate casiaEsCreate = new CasiaEsCreate("headlines");
...
//        String[] indexNames = {"all-m-news-2021-03","all-m-blog-2021-03","all-m-mblog-2021-03","all-m-video-2021-03","all-m-app-2021-03","all-m-forum-2021-03","all-m-subscriptions-2021-03","all-m-chat-2021-03"};
    ...
    public void testWriteData2() {
        CasiaEsCreate casiaEsCreate = new CasiaEsCreate("headlines");
        casiaEsCreate.setIndexName("os-headlines-news-2022-12","headlines");
        ...
        object.put("pubtime","2022-11-11 20:01:11");
        JSONObject cc = new JSONObject();
        cc.put("stance_info",object);
...
//        object2.put("title.title","张三李四");
        object2.put("id","d556b9a5998167073e8dbf8926c99531");
        ...
        CasiaEsSearch casiaEsSearch = new CasiaEsSearch("headlines");
        casiaEsSearch.setIndexName("test","test_data");
        casiaEsSearch
//                .setQueryKeyWords(
//                new KeywordsCombine(1,
//                        new KeyWordsBuider("image_extraction_info.image_type","手势", FieldOccurs.INCLUDES, QueriesLevel.Phrase)
////                        ,new KeyWordsBuider("tendency_level","3", FieldOccurs.INCLUDES, QueriesLevel.Phrase)
//                )
//        )
//                .setExistsFilter("image_extraction_info.image_type")
//        ;
                .setAggregations(
                new AggsFieldBuider(
                        new TermInfo("site_name#keyword",2, 0L , SortOrder.DESC)
                )
        );
    ...
    public void testWriteData() {
        ...
        casiaEsCreate.setIndexName("os-analysisi-news-*","analysisi");
        List<JSONObject> c= new ArrayList<>();
        c.add(datas.get(0));
        Map<String,Object> rss =casiaEsCreate.writeDatas( c,"id");
        rss.forEach((k,v)->{
...
//        });
    ...
    public void testInsertField2() {
        CasiaEsQuery casiaEsQuery = new CasiaEsQuery("person");
        casiaEsQuery.queryIndexNames().forEach(s->{
            if(s.startsWith("all-p-")){
                CasiaEsCreate casiaEsCreate = new CasiaEsCreate("person");
...
//              map.put("store", "true");
//                boolean rs = casiaEsCreate.insertField("instime",map);

                JSONObject jsonObject = JSONObject.parseObject(CasiaFileUtil.readAllBytes("mapping/json.d"));
                boolean rs = casiaEsCreate.insertField2("auto_id",jsonObject);
